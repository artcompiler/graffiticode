...
CPPPATH_PG = ['/Library/PostgreSQL/9.3/include']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/jeffdyer/.node_libraries'
LIBPATH_NODE = '/opt/local/lib'
LIBPATH_PG = ['/Library/PostgreSQL/9.3/lib']
LIBPATH_ST = '-L%s'
LIB_PG = ['pq']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/jeffdyer/.node_libraries'
